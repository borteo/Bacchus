...
var App = function (_Component) {
  ...
  createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('/api/current-user').then(function (response) {
...
var Location = function (_Component) {
  inherits(Location, _Component);

  function Location(props) {
    classCallCheck(this, Location);

    var _this = possibleConstructorReturn(this, (Location.__proto__ || Object.getPrototypeOf(Location)).call(this, props));
  ...
  createClass(Location, [{
    ...
    value: function handleLocation() {
      // remove white spaces
      var input = this.state.input.replace(/\s+/, "");
...
var Tools = function (_Component) {
  ...
  function Tools(props) {
    ...
    return possibleConstructorReturn(this, (Tools.__proto__ || Object.getPrototypeOf(Tools)).call(this, props));
  }
...
var LocationComponent = function (_Component) {
  inherits(LocationComponent, _Component);

  function LocationComponent() {
    classCallCheck(this, LocationComponent);

    var _this = possibleConstructorReturn(this, (LocationComponent.__proto__ || Object.getPrototypeOf(LocationComponent)).call(this));
  ...
  createClass(LocationComponent, [{
    key: 'setLocation',
    value: function setLocation(inputData) {
      var that = this;
      this.setState({ done: false });

      var uri = ['/api/location/', inputData].join('');

      fetch(uri).then(function (resp) {}).then(function (a) {
    ...
    value: function checkUsers() {
      var that = this;
      fetch('/api/check-users').then(function (response) {
        return response.json();
      }).then(function (json) {
        console.log('parsed json', json);
      }).catch(function (ex) {
    ...
    key: 'autolike',
    value: function autolike() {
      var that = this;
      fetch('/api/autolike').then(function (response) {
        return response.json();
      }).then(function (json) {
        console.log('parsed json', json);
      }).catch(function (ex) {
    ...
    key: 'autofollow',
    value: function autofollow() {
      var that = this;
      fetch('/api/autofollow').then(function (response) {
        return response.json();
      }).then(function (json) {
        console.log('parsed json', json);
      }).catch(function (ex) {
...
var LikeFeed = function (_Component) {
  inherits(LikeFeed, _Component);

  function LikeFeed(props) {
    classCallCheck(this, LikeFeed);
    return possibleConstructorReturn(this, (LikeFeed.__proto__ || Object.getPrototypeOf(LikeFeed)).call(this, props));
  }

  createClass(LikeFeed, [{
    key: "render",
    value: function render() {
      return h(
        "div",
...
var LikeFeedComponent = function (_Component) {
  inherits(LikeFeedComponent, _Component);

  function LikeFeedComponent() {
    classCallCheck(this, LikeFeedComponent);

    var _this = possibleConstructorReturn(this, (LikeFeedComponent.__proto__ || Object.getPrototypeOf(LikeFeedComponent)).call(this));

    _this.state = { done: false };
    return _this;
  }

  createClass(LikeFeedComponent, [{
    key: 'likeFeed',
    value: function likeFeed() {
      var that = this;

      this.setState({ done: false });

      fetch('/api/like-feed').then(function (resp) {}).then(function (a) {
        that.setState({ done: true });
      });
    }
  }, {
    key: 'render',
    value: function render() {
      return h(LikeFeed, { likeFeed: this.likeFeed.bind(this), done: this.state.done });
    }
  }]);
  return LikeFeedComponent;
}(Component);
...
return isNumber(value)&&value!=+value;}/**
     ...
     * _.toArray(null);
     * // => []
     */function toArray$$1(value){if(!value){return[];}if(isArrayLike(value)){return isString(value)?stringToArray(value):copyArray(value);}if(symIterator&&value[symIterator]){return iteratorToArray(value[symIterator]());}var tag=getTag(value),func=tag==mapTag?mapToArray:tag==setTag?setToArray:values;return func(value);}/**
...
var Unfollow = function (_Component) {
  inherits(Unfollow, _Component);

  function Unfollow(props) {
    classCallCheck(this, Unfollow);
    return possibleConstructorReturn(this, (Unfollow.__proto__ || Object.getPrototypeOf(Unfollow)).call(this, props));
  }

  createClass(Unfollow, [{
    key: "render",
    value: function render() {
      return h(
        "div",
...
var UnfollowTable = function (_Component) {
  inherits(UnfollowTable, _Component);

  function UnfollowTable(props) {
    classCallCheck(this, UnfollowTable);
    return possibleConstructorReturn(this, (UnfollowTable.__proto__ || Object.getPrototypeOf(UnfollowTable)).call(this, props));
  }

  createClass(UnfollowTable, [{
    key: "render",
    value: function render() {
      return h(
        "div",
  ...
  return UnfollowTable;
}(Component);

var jerksLimit = 25;

var UnfollowComponent = function (_Component) {
  inherits(UnfollowComponent, _Component);

  function UnfollowComponent() {
    classCallCheck(this, UnfollowComponent);

    var _this = possibleConstructorReturn(this, (UnfollowComponent.__proto__ || Object.getPrototypeOf(UnfollowComponent)).call(this));
  ...
  createClass(UnfollowComponent, [{
    ...
    key: 'saveConnections',
    value: function saveConnections() {
      var that = this;
      fetch('/api/save-connections').then(function (response) {}).then(function (json) {
        that.getConnections();
      }).catch(function (ex) {
        console.log('parsing failed', ex);
      });
    ...
    value: function getConnections() {
      var that = this;
      fetch('/api/connections').then(function (response) {
        return response.json();
      }).then(function (json) {
        that.setState({ followings: json.followings });
        that.setState({ followers: json.followers });

        var diff = _.differenceBy(that.state.followings, that.state.followers, 'id');
    ...
    key: 'unfollowJerks',
    value: function unfollowJerks() {
      var jerks = this.state.jerks.slice(0, jerksLimit);
    ...
    value: function handleSelectChange(e) {
      var options$$1 = e.target.options;
      jerksLimit = options$$1[options$$1.selectedIndex].value;
    }
  }, {
    key: 'render',
    value: function render() {
      return h(
        ...
        h(
          'div',
          { 'class': 'row' },
          h(UnfollowTable, { header: "Followers", data: this.state.followers }),
          h(UnfollowTable, { header: "Followings", data: this.state.followings }),
          h(UnfollowTable, { header: "Jerks", data: this.state.jerks })
        )
      );
    }
  }]);
  return UnfollowComponent;
}(Component);

var InstagramUsersComponent = function (_Component) {
  inherits(InstagramUsersComponent, _Component);

  function InstagramUsersComponent() {
    classCallCheck(this, InstagramUsersComponent);

    var _this = possibleConstructorReturn(this, (InstagramUsersComponent.__proto__ || Object.getPrototypeOf(InstagramUsersComponent)).call(this));
  ...
  createClass(InstagramUsersComponent, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var that = this;

      fetch('/api/instagram-users').then(function (response) {
        return response.json();
      }).then(function (json) {
        that.setState({
          users: json,
    ...
    value: function setPagination() {
      var currentPage = this.state.page * this.state.rows;
      var nextPage = (this.state.page + 1) * this.state.rows;
      var page = this.state.usersFiltered.slice(currentPage, nextPage);
      var pages = Math.floor(this.state.users.length / this.state.rows);
    ...
    key: 'filterUsers',
    value: function filterUsers(prop) {
      var users = void 0;
      var filters = {};
    ...
    key: 'handleHidePrivateClick',
    value: function handleHidePrivateClick() {
      this.setState({ isHidePrivate: !this.state.isHidePrivate });
      this.filterUsers();
      this.setPagination();
    }
  }, {
    key: 'handleHideBadFollowersClick',
    value: function handleHideBadFollowersClick() {
      ...
      return h(
        ...
        h(
          ...
          h(
            ...
            h(
              ...
              h('i', { 'class': 'fa fa-arrow-right', 'aria-hidden': 'true' })
            )
          )
        ),
        h(
          ...
          null,
          'Users (',
          this.state.usersFiltered.length,
          '/',
        ...
        h(
          ...
          h(
            'tbody',
            null,
            this.state.usersPage.map(function (user, index) {
              return h(
                'tr',
                { key: index, 'class': user.isPrivate ? "danger" : "" },
                h(
                  'th',
                  { scope: 'row' },
                  index + 1
                ...
                h(
                  'td',
                  null,
                  h('i', { 'class': user.isPrivate === true ? "red fa fa-lock" : "green fa fa-unlock" })
                ),
                h(
                  'td',
                  null,
                  h('i', { 'class': user.isGoodCandidate === true ? "green fa fa-thumbs-o-up" : "red fa fa-thumbs-o-down" })
                ),
                h(
                  'td',
                  null,
                  h('i', { 'class': user.isUpdated === true ? "green fa fa-check-circle-o" : "orange fa fa-question-circle-o" })
                ),
                h(
                  'td',
                  null,
                  h('i', { 'class': user.isLiked === true ? "green fa fa-thumbs-o-up" : "orange fa fa-ellipsis-h" })
                ),
                h(
                  'td',
                  null,
                  h('i', { 'class': user.isFollowed === true ? "green fa fa-heart-o" : "orange fa fa-ellipsis-h" })
                )
              );
            })
          )
  ...
  return InstagramUsersComponent;
}(Component);

var UnfollowComponent$2 = function (_Component) {
  inherits(UnfollowComponent, _Component);
  ...
  createClass(UnfollowComponent, [{
    ...
    value: function handleSubmit() {
      ...
      var uri = ['/api/instagrammer/', input].join('');
...
var botComponent = function (_Component) {
  inherits(botComponent, _Component);

  function botComponent() {
    classCallCheck(this, botComponent);
    return possibleConstructorReturn(this, (botComponent.__proto__ || Object.getPrototypeOf(botComponent)).call(this));
  }

  createClass(botComponent, [{
    key: 'startBot',
    value: function startBot() {
      var that = this;

      fetch('start-bot').then(function (resp) {}).then(function (a) {});
    }
  }, {
    key: 'render',
    value: function render() {
...
render$1(h(LikeFeedComponent, null), document.querySelector('.like-feed-component'));
